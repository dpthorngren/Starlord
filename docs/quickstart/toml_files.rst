...
2. Create a TOML file and list your constraints under the heading ``[models]`` like ``grid.var = ['normal', 3.4, 2.0]`` (distribution and parameters, see :class:`starlord.ModelBuilder`).
